...
const seed = async () => {
    ...
    await Project.create([
        ...
        },
        {
            ...
            sanitizedHtml:
                '<h2 id="project-summary-wakatime">Project Summary <a href="https://wakatime.com/badge/github/irackson/PortfolioWebsite"><img alt="wakatime" src="https://wakatime.com/badge/github/irackson/PortfolioWebsite.svg"></a></h2>\n<ul>\n<li>  This project serves as the backend of my personal website / portfolio / blog</li>\n</ul>\n<h2 id=""></h2>\n<h2 id="technology-used">Technology Used</h2>\n<h3 id="dependencies">Dependencies</h3>\n<ul>\n<li><p>  <a href="https://www.npmjs.com/package/mongoose">mongoose</a> (for <a href="https://www.mongodb.com/">MongoDB</a> database operations)</p>\n</li>\n<li><p>  <a href="https://www.npmjs.com/package/express">express</a> / <a href="https://www.npmjs.com/package/express-session">express-session</a> / <a href="https://www.npmjs.com/package/method-override">method-override</a> / <a href="https://www.npmjs.com/package/cors">cors</a></p>\n</li>\n<li><p>  <a href="https://www.npmjs.com/package/bcryptjs">bcryptjs</a> / <a href="https://www.npmjs.com/package/dotenv">dotenv</a></p>\n</li>\n<li><p>  <a href="https://www.npmjs.com/package/marked">marked</a> / <a href="https://www.npmjs.com/package/dompurify">dompurify</a> / <a href="https://www.npmjs.com/package/jsdom">jsdom</a></p>\n</li>\n<li><p>  <a href="https://www.npmjs.com/package/slugify">slugify</a></p>\n</li>\n<li><p>  <a href="https://www.npmjs.com/package/nodemailer">nodemailer</a> / <a href="https://www.npmjs.com/package/nodemailer-mailgun-transport">nodemailer-mailgun-transport</a></p>\n</li>\n</ul>\n<h3 id="workflow-developer-dependencies">Workflow (Developer Dependencies)</h3>\n<ul>\n<li><p>  VS Code tasks</p>\n</li>\n<li><p>  <a href="https://www.npmjs.com/package/nodemon">nodemon</a></p>\n</li>\n<li><p>  <a href="https://www.npmjs.com/package/gulp">gulp</a> / <a href="https://www.npmjs.com/package/gulp-dart-sass">gulp-dart-sass</a> / <a href="https://www.npmjs.com/package/gulp-concat">gulp-concat</a> / <a href="https://www.npmjs.com/package/gulp-postcss">gulp-postcss</a> / <a href="https://www.npmjs.com/package/gulp-sourcemaps">gulp-sourcemaps</a> / <a href="https://www.npmjs.com/package/gulp-uglify">gulp-uglify</a> / <a href="https://www.npmjs.com/package/autoprefixer">autoprefixer</a> / <a href="https://www.npmjs.com/package/cssnano">cssnano</a></p>\n</li>\n</ul>\n<h3 id="agile-project-management">Agile Project Management</h3>\n<ul>\n<li><p>  <a href="https://trello.com/invite/b/VVhnA2Ep/0b2b28bebd161fbfa902d7be50dd657b/porfoliowebsite">Trello</a> (for User Stories, Ice Box, Current/MVP, Completed)</p>\n</li>\n<li><p><a href="https://app.diagrams.net/">diagrams.net</a> (for Sitemap)</p>\n<p>  <img alt="" src="https://trello-attachments.s3.amazonaws.com/606ce72d6fdb47289f6c9435/607127033a4d7f62ea5be511/84a351a1738c1d36fa00bdb81bb0332d/5fg8Fwu.png"></p>\n</li>\n<li><p><a href="https://www.figma.com/file/ku3I4S26RbzT23bggfxzdV/Wireframes?node-id=0%3A1">Figma</a> (for Wireframes)</p>\n<p>  Home page (desktop)</p>\n<p>  <img alt="" src="https://trello-attachments.s3.amazonaws.com/606ce72d6fdb47289f6c9435/60721c018daf1f42aa5e0c1a/c3a5c8f251c66b74f35a87ea05d4fe53/m1wOIYb.png"></p>\n<p>  Home page (mobile)</p>\n<p>  <img alt="" src="https://trello-attachments.s3.amazonaws.com/606ce72d6fdb47289f6c9435/60721ce832b49e4061b9a8a7/289ec6f9e2d52827dfda39a170585795/lHAAfCz.png"></p>\n<p>  Apps page (currently Projects)</p>\n<p>  <img alt="" src="https://trello-attachments.s3.amazonaws.com/606ce72d6fdb47289f6c9435/60721bbe55b5356d925fae6a/d72466e75483382d45cc81dbb313c2cd/LX8dFf9.png"></p>\n</li>\n</ul>\n<h2 id="models">Models</h2>\n<h3 id="user-model">User Model:</h3>\n<pre><code class="language-javascript">const UserSchema = new Schema(\n    {\n        username: { type: String, unique: true, required: true },\n        password: { type: String, required: true },\n        admin: { type: Boolean, required: true },\n        vip: { type: Boolean, default: false },\n    },\n    { timestamps: true }\n);\n</code></pre>\n<h3 id="nav-model-navigation">Nav Model (Navigation):</h3>\n<pre><code class="language-javascript">const NavSchema = new Schema(\n    {\n        name: { type: String, required: true, unique: true },\n        dir: { type: String, required: true, unique: true },\n        visible: { type: Boolean, default: true },\n        position: { type: Number, required: true },\n    },\n    { timestamps: true }\n);\n</code></pre>\n<h3 id="project-model">Project Model:</h3>\n<p>(same as Blog Model but with liveLink and codeLink properties added)</p>\n<pre><code class="language-javascript">const ProjectSchema = new Schema(\n    {\n        title: { type: String, required: true },\n        liveLink: { type: String, required: true },\n        codeLink: { type: String, default: \'https://github.com/irackson\' },\n        description: { type: String, required: true },\n        tags: { type: [String], required: true },\n        visible: { type: Boolean, default: false },\n        previouslySent: { type: Boolean, default: false },\n        markdown: { type: String, required: true },\n        featured: { type: Boolean, default: false },\n        thumbnail: {\n            type: String,\n            default: \'relevant-stock-icon.png\',\n        },\n        slug: {\n            type: String,\n            required: true,\n            unique: true,\n        },\n        sanitizedHtml: {\n            type: String,\n            required: true,\n        },\n    },\n    { timestamps: true }\n);\n\nProjectSchema.pre(\'validate\', function (next) {\n    if (this.title) {\n        this.slug = slugify(this.title, { lower: true, strict: true });\n    }\n\n    if (this.markdown) {\n        this.sanitizedHtml = dompurify.sanitize(marked(this.markdown));\n    }\n\n    next();\n});\n</code></pre>\n<h3 id="sub-model-subscription">Sub Model (Subscription):</h3>\n<pre><code class="language-javascript">const SubSchema = new Schema(\n    {\n        contentType: {\n            type: Schema.Types.ObjectId,\n            ref: \'Nav\',\n            required: true,\n        },\n        subscribers: {\n            type: [\n                {\n                    first_name: { type: String },\n                    email: { type: String, required: true },\n                    confirmation: { type: Boolean, default: false },\n                    account: { type: Schema.Types.ObjectId, ref: \'User\' },\n                },\n            ],\n            active: { type: Boolean, default: false },\n            default: [],\n        },\n    },\n    { timestamps: true }\n);\n</code></pre>\n<h2 id="route-maps">Route Maps</h2>\n<h3 id="users-users">Users ("/users")</h3>\n<table>\n<thead>\n<tr>\n<th>Method</th>\n<th>Endpoint</th>\n<th>Resource/View</th>\n</tr>\n</thead>\n<tbody><tr>\n<td>GET</td>\n<td>"/create"</td>\n<td>Render form for new User (users/create.ejs)</td>\n</tr>\n<tr>\n<td>POST</td>\n<td>"/create"</td>\n<td>Uses Form Submission to Create new User</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/login"</td>\n<td>Display a Particular Post (projects/show.ejs)</td>\n</tr>\n<tr>\n<td>POST</td>\n<td>"/login"</td>\n<td>Render form to User login&nbsp; (projects/update.ejs)</td>\n</tr>\n<tr>\n<td>POST</td>\n<td>"/subscribe"</td>\n<td>Uses partials/footer.ejs Form Submission to Subscribe</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/unsubscribe/*"</td>\n<td>Render form to Unsubscribe&nbsp; (users/unsubscribe.ejs)</td>\n</tr>\n<tr>\n<td>POST</td>\n<td>"/unsubscribe/*"</td>\n<td>Uses Form Submission to Unsubscribe</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/logout"</td>\n<td>Logout a particular User</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/*"</td>\n<td>Catch-all redirect to "/" (home page)</td>\n</tr>\n</tbody></table>\n<h3 id="projects-projects">Projects ("/projects")</h3>\n<table>\n<thead>\n<tr>\n<th>Method</th>\n<th>Endpoint</th>\n<th>Resource/View</th>\n</tr>\n</thead>\n<tbody><tr>\n<td>GET</td>\n<td>"/"</td>\n<td>List all Posts (projects/index.ejs)</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/create"</td>\n<td>Render form for New Post (projects/create.ejs)</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/:slug"</td>\n<td>Display a Particular Post (projects/show.ejs)</td>\n</tr>\n<tr>\n<td>POST</td>\n<td>"/"</td>\n<td>Uses Form Submission to Create new Post</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/:slug/update"</td>\n<td>Render form to edit Post&nbsp; (projects/update.ejs)</td>\n</tr>\n<tr>\n<td>PUT</td>\n<td>"/:slug"</td>\n<td>Uses Form Submission to edit Post</td>\n</tr>\n<tr>\n<td>DELETE</td>\n<td>"/:slug"</td>\n<td>Delete a particular Post</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/*"</td>\n<td>Catch-all redirect to "/projects"</td>\n</tr>\n</tbody></table>\n<h3 id="blog-blog">Blog ("/blog")</h3>\n<table>\n<thead>\n<tr>\n<th>Method</th>\n<th>Endpoint</th>\n<th>Resource/View</th>\n</tr>\n</thead>\n<tbody><tr>\n<td>GET</td>\n<td>"/"</td>\n<td>List all Posts (blog/index.ejs)</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/create"</td>\n<td>Render form for New Post (blog/create.ejs)</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/:slug"</td>\n<td>Display a Particular Post (blog/show.ejs)</td>\n</tr>\n<tr>\n<td>POST</td>\n<td>"/"</td>\n<td>Uses Form Submission to Create new Post</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/:slug/update"</td>\n<td>Render form to edit Post&nbsp; (blog/update.ejs)</td>\n</tr>\n<tr>\n<td>PUT</td>\n<td>"/:slug"</td>\n<td>Uses Form Submission to edit Post</td>\n</tr>\n<tr>\n<td>DELETE</td>\n<td>"/:slug"</td>\n<td>Delete a particular Post</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/*"</td>\n<td>Catch-all redirect to "/blog"</td>\n</tr>\n</tbody></table>\n<h3 id="metrics-metrics">Metrics ("/metrics")</h3>\n<table>\n<thead>\n<tr>\n<th>Method</th>\n<th>Endpoint</th>\n<th>Resource/View</th>\n</tr>\n</thead>\n<tbody><tr>\n<td>GET</td>\n<td>"/"</td>\n<td>List all Metrics ("metrics/index.ejs")</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/*"</td>\n<td>Catch-all redirect to "/metrics"</td>\n</tr>\n</tbody></table>\n<h3 id="resume-resume">Resume ("/resume")</h3>\n<table>\n<thead>\n<tr>\n<th>Method</th>\n<th>Endpoint</th>\n<th>Resource/View</th>\n</tr>\n</thead>\n<tbody><tr>\n<td>GET</td>\n<td>"/"</td>\n<td>Render Resume page ("resume/index.ejs")</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/download"</td>\n<td>Download Resume from public assets</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/*"</td>\n<td>Catch-all redirect to "/resume"</td>\n</tr>\n</tbody></table>\n<h3 id="webmaster-webmaster">Webmaster ("/webmaster")</h3>\n<table>\n<thead>\n<tr>\n<th>Method</th>\n<th>Endpoint</th>\n<th>Resource/View</th>\n</tr>\n</thead>\n<tbody><tr>\n<td>GET</td>\n<td>"/"</td>\n<td>Render form for Sitewide Settings (webmaster/settings.ejs)</td>\n</tr>\n<tr>\n<td>POST</td>\n<td>"/seed"</td>\n<td>Reseed the Database</td>\n</tr>\n<tr>\n<td>PUT</td>\n<td>"/"</td>\n<td>Uses Form Submission to edit Sitewide Settings</td>\n</tr>\n<tr>\n<td>GET</td>\n<td>"/*"</td>\n<td>Catch-all redirect to "/webmaster"</td>\n</tr>\n</tbody></table>\n<h2 id="challenges">Challenges</h2>\n<ul>\n<li>  Too many to count!</li>\n</ul>\n<h2 id="existing-bugs">Existing Bugs</h2>\n<ul>\n<li>  There are over nine hundred thousand different different species of bugs</li>\n</ul>\n<h2 id="notes">Notes</h2>\n<ul>\n<li><p>to render code in markdown properly with prism, you must use this pattern:</p>\n<p>  <code>&lt;pre&gt;&lt;code class="language-css"&gt;p { color: red }&lt;/code&gt;&lt;/pre&gt;</code></p>\n</li>\n</ul>\n',
        },
    ]);
